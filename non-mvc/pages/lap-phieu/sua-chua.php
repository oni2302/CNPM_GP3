...
<body>
  ...
  <main class="content">
    ...
    <div class="row">
                <div class="col-lg-4 col-sm-6">
                  <label for="checkName">Phụ kiện</label>
                ...
                <div class="col-lg-4 col-sm-6">
                  <div class="mb-4">
                    <label for="percent">Số lượng</label>
                ...
                <div class="col-lg-2">
                  <div class="mb-4">
                    ...
                    <input class="form-control" id="cost" disabled>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0 rounded" id="table">
                      <thead class="thead-light">
                        <tr>
                          <th class="border-0 rounded-start">#</th>
                          <th class="border-0">Tên phụ kiện</th>
                          <th class="border-0">Số lượng</th>
                          <th class="border-0">Giá thành</th>
                        </tr>
                      </thead>
                      <tbody>
                      </tbody>
