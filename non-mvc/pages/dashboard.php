      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a href="https://oni2302.tech" target="_blank" class="nav-link d-flex align-items-center">
            <span class="sidebar-icon">
              <img src="../assets/img/logo_oni.jpg" height="20" width="28" alt="ONI">
            </span>
          ...
          <div class="d-flex align-items-center">
            ...
            <form action="../database/tim-kiem-dat-lich.php" class="navbar-search form-inline" id="navbar-search-main">
              <div class="input-group input-group-merge search-bar">
                ...
                <input type="text" class="form-control" id="topbarInputIconLeft" placeholder="Tìm kiếm lịch đặt" aria-label="Search" aria-describedby="topbar-addon">
              </div>
            </form>
            <!-- / Search form -->
          </div>
                  ...
                  <a href="#" class="list-group-item list-group-item-action border-bottom">
                    <div class="row align-items-center">
                      ...
                      <div class="col ps-0 ms-2">
                        <div class="d-flex justify-content-between align-items-center">
                          <div>
                            <h4 class="h6 mb-0 text-small"><?php echo $user['_ten']; ?></h4>
                          </div>
                          <div class="text-end">
            ...
            <form>
              ...
              <div class="row mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control" id="text" placeholder="Nội dung ghi chú..." name="car_id">
                  </div>
                <div class="mb-4">
