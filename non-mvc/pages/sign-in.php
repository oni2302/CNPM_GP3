...
<body>
    ...
    <main>
        ...
        <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
            <div class="container">
                <p class="text-center">
                    <a href="../dashboard/dashboard.php" class="d-flex align-items-center justify-content-center">
                ...
                <div class="row justify-content-center form-bg-image" data-background-lg="../../assets/img/illustrations/signin.svg">
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <form action="../database/sign-in.php" method="post" class="mt-4">
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" placeholder="example@email.com" id="email" name="email" autofocus required oninvalid="this.setCustomValidity('Điền email vào đây')">
                                    </div>  
                                </div>
                                <!-- End of Form -->
                                <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" placeholder="Password" class="form-control" id="password" name="password" required oninvalid="this.setCustomValidity('Điền mật khẩu vào đây')">
                                        </div>  
                                    </div>
                                    <!-- End of Form -->
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    Chưa có tài khoản?
                                    <a href="./sign-up.php" class="fw-bold">Đăng kí</a>
                                </span>
                            </div>
                        </div>
                    </div>
