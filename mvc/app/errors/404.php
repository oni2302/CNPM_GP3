        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center d-flex align-items-center justify-content-center">
                    <div>
                        <img class="img-fluid w-75" src="<?php echo _WEB_ROOT;?>/app/public/assets/img/illustrations/404.svg" alt="404 not found">
                        <h1 class="mt-5">00 <span class="fw-bolder text-primary">Thấy</span></h1>
                        <p class="lead my-4">Ừm ừm... Lỗi tí, mà đa phần là do phá chứ sao có lỗi này được ?</p>
